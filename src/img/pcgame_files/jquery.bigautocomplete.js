	...
	var bigAutocomplete = new function(){
		...
		this.init = function(){
			...
			$("#bigAutocompleteContent").delegate("tr", "click", function() {
				var obj=$(this).find("div:last");
				bigAutocomplete.currentInputText.attr("data-id",obj.attr("data-id"));
				bigAutocomplete.currentInputText.val( obj.html());
				if($("#commodity_id")) $("#commodity_id").val(obj.attr("data-id"));
		...
		this.autocomplete = function(param){
			...
			function makeContAndShow(data_){
				...
				for(var i=0;i<data_.length;i++){
					cont += "<tr><td><div data-id='"+data_[i].pid+"' data-name='"+data_[i].title+"'>" + data_[i].title + "</div></td></tr>"
				}
				cont += "</tbody></table>";
